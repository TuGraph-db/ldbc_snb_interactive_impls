...
public class LightGraphRpcException extends RuntimeException {
    private static final long serialVersionUID = 7382581401295703844L;
    public Lgraph.LGraphResponse.ErrorCode errorCode;
    public String error;
    public String errorMethod;
    
    public LightGraphRpcException(Lgraph.LGraphResponse.ErrorCode errorCode, String error, String errorMethod) {
        super(error);
